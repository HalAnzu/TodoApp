...
<head>
    <meta charset="UTF-8">
    <title>システムエラー - TaskManager</title>
    <style>
        ...
        h1 { color: #d9534f; font-size: 28px; margin-bottom: 20px; }
        .error-message { font-size: 16px; color: #666; line-height: 1.6; margin-bottom: 30px; }
        .btn { display: inline-block; background-color: #6c757d; color: white; padding: 10px 20px; text-decoration: none; border-radius: 4px; font-weight: bold; }
        .btn:hover { background-color: #5a6268; }
    </style>
</head>
<body>
    <div class="error-container">
        <h1>システムエラーが発生しました (500)</h1>
        <p class="error-message">
            アプリケーション内部で予期しない問題が発生しました。<br>
            時間をおいてもう一度お試しいただくか、管理者へお問い合わせください。
        </p>
